...
import edu.neu.ccs.demeterf.lib.verbatim;
  ...
  final public MMGInstance parse_MMGInstance() throws ParseException {
     double x;
    x = parse_double();
      {if (true) return new MMGInstance(x);}
    throw new Error("Missing return statement in function");
  }

  final public MMGSolution parse_MMGSolution() throws ParseException {
     double y;
    y = parse_double();
      {if (true) return new MMGSolution(y);}
    throw new Error("Missing return statement in function");
  }

  final public MMGInstanceSet parse_MMGInstanceSet() throws ParseException {
      {if (true) return new MMGInstanceSet();}
    throw new Error("Missing return statement in function");
  }

  final public MMGDomain parse_MMGDomain() throws ParseException {
      {if (true) return new MMGDomain();}
    throw new Error("Missing return statement in function");
  }

  final public MMGConfig parse_MMGConfig() throws ParseException {
    jj_consume_token(1);
    jj_consume_token(2);
      {if (true) return new MMGConfig();}
    throw new Error("Missing return statement in function");
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x8,0x60,0x180,0x6000,0x70000,0x6000,0x0,0x0,0x0,0x6000,0x70000,0x0,0x0,0x6000,0x180,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0xc0000,0x0,0x0,0x0,0x0,0x0,0x0,0x34,0xc0,0x800000,0x0,0x0,0x800000,0x800000,0x0,0x0,};
   }
