...
public class HashCode extends edu.neu.ccs.demeterf.FC{
   ...
   public int combine(MMGInstance _h_, int x)
   { return x; }
   public int combine(MMGSolution _h_, int y)
   { return y; }
   public int combine(MMGInstanceSet _h_)
   { return 545857330; }
   public int combine(MMGDomain _h_)
   { return -125225247; }
   public int combine(MMGConfig _h_)
   { return -211008933; }
