...
public class Display extends edu.neu.ccs.demeterf.FC{
   ...
   public String combine(MMGInstance _h_, String x, String _d_){
      return ": MMGInstance ("+"\n"+_d_+"<x> "+x+" )";
   }
   public String combine(MMGSolution _h_, String y, String _d_){
      return ": MMGSolution ("+"\n"+_d_+"<y> "+y+" )";
   }
   public String combine(MMGInstanceSet _h_, String _d_){
      return ": MMGInstanceSet ("+" )";
   }
   public String combine(MMGDomain _h_, String _d_){
      return ": MMGDomain ("+" )";
   }
   public String combine(MMGConfig _h_, String _d_){
      return ": MMGConfig ("+" )";
   }
