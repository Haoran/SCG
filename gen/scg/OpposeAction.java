...
public abstract class OpposeAction{
    ...
    public static OpposeAction parse(String inpt) throws scg.ParseException{
        return new scg.TheParser(new java.io.StringReader(inpt)).parse_OpposeAction();
    }
    ...
    public static OpposeAction parse(java.io.InputStream inpt) throws scg.ParseException{
        return new scg.TheParser(inpt).parse_OpposeAction();
    }
