...
import edu.neu.ccs.demeterf.lib.verbatim;
  ...
  final public SmartHistory parse_SmartHistory() throws ParseException {
    ...
    player2Score = parse_double();
      {if (true) return new SmartHistory(loc,player1,player1Score,player2,player2Score);}
    throw new Error("Missing return statement in function");
  }

  final public ClaimWithResponse parse_ClaimWithResponse() throws ParseException {
     Claim claim;
     verbatim proposer;
     verbatim opposer;
    ...
    pointsWon = parse_double();
      {if (true) return new ClaimWithResponse(claim,proposer,opposer,opposeAction,responses,winner,pointsWon);}
    throw new Error("Missing return statement in function");
  }

  final public AnnotatedResponse parse_AnnotatedResponse() throws ParseException {
     verbatim provider;
     ProtocolResponse pr;
    jj_consume_token(8);
    ...
    pr = parse_ProtocolResponse();
      {if (true) return new AnnotatedResponse(provider,pr);}
    throw new Error("Missing return statement in function");
  }

  final public RawHistory parse_RawHistory() throws ParseException {
    ...
    player2 = parse_verbatim();
    player2Score = parse_double();
      {if (true) return new RawHistory(entries,player1,player1Score,player2,player2Score);}
    throw new Error("Missing return statement in function");
  }

  final public RHEntry parse_RHEntry() throws ParseException {
     Request request;
     Reply reply;
     verbatim teamName;
     double reputation;
    ...
    reputation = parse_double();
      {if (true) return new RHEntry(request,reply,teamName,reputation);}
    throw new Error("Missing return statement in function");
  }

  final public Reply parse_Reply() throws ParseException {
    Reply sup = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 21:
      sup = parse_HistoryResponse();
                                    {if (true) return sup;}
      break;
    case TEXT:
      sup = parse_KickJustification();
                                      {if (true) return sup;}
      break;
    default:
      jj_la1[1] = jj_gen;
  ...
  final public HistoryResponse parse_HistoryResponse() throws ParseException {
     Response response;
    response = parse_Response();
      {if (true) return new HistoryResponse(response);}
    throw new Error("Missing return statement in function");
  }

  final public KickJustification parse_KickJustification() throws ParseException {
     verbatim reason;
    reason = parse_verbatim();
      {if (true) return new KickJustification(reason);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public List<RHEntry> parse_List$RHEntry$() throws ParseException {
    List<RHEntry> sup = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 10:
      sup = parse_Cons$RHEntry$();
                                  {if (true) return sup;}
      break;
    default:
      jj_la1[17] = jj_gen;
      sup = parse_Empty$RHEntry$();
                                   {if (true) return sup;}
    }
    throw new Error("Missing return statement in function");
  }

  final public Empty<RHEntry> parse_Empty$RHEntry$() throws ParseException {
      {if (true) return new Empty<RHEntry>();}
    throw new Error("Missing return statement in function");
  }

  final public Cons<RHEntry> parse_Cons$RHEntry$() throws ParseException {
     RHEntry first;
     List<RHEntry> rest;
    first = parse_RHEntry();
    rest = parse_List$RHEntry$();
      {if (true) return new Cons<RHEntry>(first,rest);}
    throw new Error("Missing return statement in function");
  }

  final public List<AnnotatedResponse> parse_List$AnnotatedResponse$() throws ParseException {
    List<AnnotatedResponse> sup = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 8:
      sup = parse_Cons$AnnotatedResponse$();
                                            {if (true) return sup;}
      break;
    default:
      jj_la1[18] = jj_gen;
      sup = parse_Empty$AnnotatedResponse$();
                                             {if (true) return sup;}
    }
    throw new Error("Missing return statement in function");
  }

  final public Empty<AnnotatedResponse> parse_Empty$AnnotatedResponse$() throws ParseException {
      {if (true) return new Empty<AnnotatedResponse>();}
    throw new Error("Missing return statement in function");
  }

  final public Cons<AnnotatedResponse> parse_Cons$AnnotatedResponse$() throws ParseException {
     AnnotatedResponse first;
     List<AnnotatedResponse> rest;
    first = parse_AnnotatedResponse();
    rest = parse_List$AnnotatedResponse$();
      {if (true) return new Cons<AnnotatedResponse>(first,rest);}
    throw new Error("Missing return statement in function");
  }

  final public List<ClaimWithResponse> parse_List$ClaimWithResponse$() throws ParseException {
    List<ClaimWithResponse> sup = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 1:
      sup = parse_Cons$ClaimWithResponse$();
                                            {if (true) return sup;}
      break;
    default:
      jj_la1[19] = jj_gen;
      sup = parse_Empty$ClaimWithResponse$();
                                             {if (true) return sup;}
    }
    throw new Error("Missing return statement in function");
  }

  final public Empty<ClaimWithResponse> parse_Empty$ClaimWithResponse$() throws ParseException {
      {if (true) return new Empty<ClaimWithResponse>();}
    throw new Error("Missing return statement in function");
  }

  final public Cons<ClaimWithResponse> parse_Cons$ClaimWithResponse$() throws ParseException {
     ClaimWithResponse first;
     List<ClaimWithResponse> rest;
    first = parse_ClaimWithResponse();
    rest = parse_List$ClaimWithResponse$();
      {if (true) return new Cons<ClaimWithResponse>(first,rest);}
    throw new Error("Missing return statement in function");
  }
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x0,0x200000,0x4000,0x30000,0xc0000,0x3000000,0x38000000,0x3000000,0x0,0x0,0x0,0x3000000,0x38000000,0x0,0x0,0x3000000,0xc0000,0x400,0x100,0x2,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0xc0000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x34000,0xc0000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_2() {
      jj_la1_2 = new int[] {0x0,0x4,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8,0x0,0x0,0x8,0x8,0x0,0x0,0x0,0x0,0x0,};
   }
