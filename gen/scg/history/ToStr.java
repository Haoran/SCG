...
public class ToStr extends edu.neu.ccs.demeterf.FC{
   ...
   public String combine(SmartHistory _h_, String loc, String player1, String player1Score, String player2, String player2Score)
   { return "SmartHistory("+loc+","+player1+","+player1Score+","+player2+","+player2Score+")"; }
   public String combine(ClaimWithResponse _h_, String claim, String proposer, String opposer, String opposeAction, String responses, String winner, String pointsWon)
   { return "ClaimWithResponse("+claim+","+proposer+","+opposer+","+opposeAction+","+responses+","+winner+","+pointsWon+")"; }
   public String combine(AnnotatedResponse _h_, String provider, String pr)
   { return "AnnotatedResponse("+provider+","+pr+")"; }
   public String combine(RawHistory _h_, String entries, String player1, String player1Score, String player2, String player2Score)
   { return "RawHistory("+entries+","+player1+","+player1Score+","+player2+","+player2Score+")"; }
   public String combine(RHEntry _h_, String request, String reply, String teamName, String reputation)
   { return "RHEntry("+request+","+reply+","+teamName+","+reputation+")"; }
   public String combine(HistoryResponse _h_, String response)
   { return "HistoryResponse("+response+")"; }
   public String combine(KickJustification _h_, String reason)
   { return "KickJustification("+reason+")"; }
