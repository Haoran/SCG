...
public class ForAllExistsMax extends ForAllExists implements ProtocolI{
	...
	/* Singleton instance*/
	private static ForAllExistsMax instance = new ForAllExistsMax();
	public ForAllExistsMax() {}
	public static ForAllExistsMax getInstance(){
		return instance;
	}

	/** Parse an instance of ForAllExists from the given String */
	public static ForAllExistsMax parse(String inpt) throws scg.ParseException{
		return instance;
	}
	/** Parse an instance of ForAllExists from the given Stream */
	public static ForAllExistsMax parse(java.io.InputStream inpt) throws scg.ParseException{
		return instance;
	}
	/** Parse an instance of ForAllExists from the given Reader */
	public static ForAllExistsMax parse(java.io.Reader inpt) throws scg.ParseException{
		return instance;
	}
