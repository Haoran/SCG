...
public class Display extends edu.neu.ccs.demeterf.FC{
   ...
   public String combine(RefutationEvent _h_, String successful, String reputation, String _d_){
      return ": RefutationEvent ("+"\n"+_d_+"<successful> "+successful+"\n"+_d_+"<reputation> "+reputation+" )";
   }
   public String combine(PersistentPlayground _h_, String config, String enrolledPlayers, String persistentClaims, String _d_){
      return ": PersistentPlayground ("+"\n"+_d_+"<config> "+config+"\n"+_d_+"<enrolledPlayers> "+enrolledPlayers+"\n"+_d_+"<persistentClaims> "+persistentClaims+" )";
   }
   public String combine(PersistentClaim _h_, String claim, String PlayerID, String refutationEvents, String _d_){
      return ": PersistentClaim ("+"\n"+_d_+"<claim> "+claim+"\n"+_d_+"<PlayerID> "+PlayerID+"\n"+_d_+"<refutationEvents> "+refutationEvents+" )";
   }
