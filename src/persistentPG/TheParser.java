...
public class TheParser implements TheParserConstants {
  ...
  final public RefutationEvent parse_RefutationEvent() throws ParseException {
     boolean successful;
     double reputation;
    jj_consume_token(1);
    successful = parse_boolean();
    reputation = parse_double();
    jj_consume_token(2);
      {if (true) return new RefutationEvent(successful,reputation);}
    throw new Error("Missing return statement in function");
  }

  final public PersistentPlayground parse_PersistentPlayground() throws ParseException {
     Config config;
     List<PlayerSpec> enrolledPlayers;
     List<PersistentClaim> persistentClaims;
    config = parse_Config();
    enrolledPlayers = parse_List$PlayerSpec$();
    persistentClaims = parse_List$PersistentClaim$();
      {if (true) return new PersistentPlayground(config,enrolledPlayers,persistentClaims);}
    throw new Error("Missing return statement in function");
  }

  final public PersistentClaim parse_PersistentClaim() throws ParseException {
     Claim claim;
     ident PlayerID;
     List<RefutationEvent> refutationEvents;
    jj_consume_token(3);
    claim = parse_Claim();
    PlayerID = parse_ident();
    refutationEvents = parse_List$RefutationEvent$();
    jj_consume_token(2);
      {if (true) return new PersistentClaim(claim,PlayerID,refutationEvents);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public List<RefutationEvent> parse_List$RefutationEvent$() throws ParseException {
    List<RefutationEvent> sup = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 1:
      sup = parse_Cons$RefutationEvent$();
                                          {if (true) return sup;}
      break;
    default:
      jj_la1[20] = jj_gen;
      sup = parse_Empty$RefutationEvent$();
                                           {if (true) return sup;}
    }
    throw new Error("Missing return statement in function");
  }

  final public Empty<RefutationEvent> parse_Empty$RefutationEvent$() throws ParseException {
      {if (true) return new Empty<RefutationEvent>();}
    throw new Error("Missing return statement in function");
  }

  final public Cons<RefutationEvent> parse_Cons$RefutationEvent$() throws ParseException {
     RefutationEvent first;
     List<RefutationEvent> rest;
    first = parse_RefutationEvent();
    rest = parse_List$RefutationEvent$();
      {if (true) return new Cons<RefutationEvent>(first,rest);}
    throw new Error("Missing return statement in function");
  }

  final public List<PersistentClaim> parse_List$PersistentClaim$() throws ParseException {
    List<PersistentClaim> sup = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 3:
      sup = parse_Cons$PersistentClaim$();
                                          {if (true) return sup;}
      break;
    default:
      jj_la1[21] = jj_gen;
      sup = parse_Empty$PersistentClaim$();
                                           {if (true) return sup;}
    }
    throw new Error("Missing return statement in function");
  }

  final public Empty<PersistentClaim> parse_Empty$PersistentClaim$() throws ParseException {
      {if (true) return new Empty<PersistentClaim>();}
    throw new Error("Missing return statement in function");
  }

  final public Cons<PersistentClaim> parse_Cons$PersistentClaim$() throws ParseException {
     PersistentClaim first;
     List<PersistentClaim> rest;
    first = parse_PersistentClaim();
    rest = parse_List$PersistentClaim$();
      {if (true) return new Cons<PersistentClaim>(first,rest);}
    throw new Error("Missing return statement in function");
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x10,0xc0,0x300,0xc000,0xe0000,0xc000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc000,0xe0000,0x0,0x0,0xc000,0x300,0x2,0x8,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x3000000,0x0,0x0,0x0,0x0,0x0,0x0,0x1a0,0x600,0x2000,0x8000000,0x1000,0x800,0x20000000,0x0,0x0,0x20000000,0x20000000,0x0,0x0,0x0,0x0,};
   }
