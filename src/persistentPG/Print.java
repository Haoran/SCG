...
public class Print extends edu.neu.ccs.demeterf.FC{
   ...
   public _LT combine(RefutationEvent _h_, _LT successful, _LT reputation){
      return empty.append(new _S("refutationEvent[")).append(successful).append(new _S(" ")).append(reputation).append(new _S("]")).append(_N.n).compress();
   }
   public _LT combine(PersistentPlayground _h_, _LT config, _LT enrolledPlayers, _LT persistentClaims){
      return empty.append(config).append(enrolledPlayers).append(persistentClaims).compress();
   }
   public _LT combine(PersistentClaim _h_, _LT claim, _LT PlayerID, _LT refutationEvents){
      return empty.append(new _S("persistentClaim[")).append(claim).append(new _S(" ")).append(PlayerID).append(new _S(" ")).append(refutationEvents).append(new _S("]")).append(_N.n).compress();
   }
   ...
   public _LT combine(SCGConfig _h_, _LT domain, _LT protocols, _LT tournamentStyle, _LT turnDuration, _LT maxNumAvatars, _LT minStrengthening, _LT initialReputation, _LT maxReputation, _LT reputationFactor, _LT minProposals, _LT maxProposals, _LT numRounds, _LT proposedClaimMustBeNew, _LT minConfidence, _LT isPersistentPlayground, _LT numOfTournamentRounds){
      return empty.append(new _S("scg_config[")).append(_N.n).append(new _S("    ")).append(new _S("domain:")).append(new _S(" ")).append(domain).append(_N.n).append(new _S("    ")).append(new _S("protocols:")).append(new _S(" ")).append(protocols).append(_N.n).append(new _S("    ")).append(new _S("tournamentStyle:")).append(new _S(" ")).append(tournamentStyle).append(_N.n).append(new _S("    ")).append(new _S("turnDuration:")).append(new _S(" ")).append(turnDuration).append(_N.n).append(new _S("    ")).append(new _S("maxNumAvatars:")).append(new _S(" ")).append(maxNumAvatars).append(_N.n).append(new _S("    ")).append(new _S("minStrengthening:")).append(new _S(" ")).append(minStrengthening).append(_N.n).append(new _S("    ")).append(new _S("initialReputation:")).append(new _S(" ")).append(initialReputation).append(_N.n).append(new _S("    ")).append(new _S("maxReputation:")).append(new _S(" ")).append(maxReputation).append(_N.n).append(new _S("    ")).append(new _S("reputationFactor:")).append(new _S(" ")).append(reputationFactor).append(_N.n).append(new _S("    ")).append(new _S("minProposals:")).append(new _S(" ")).append(minProposals).append(_N.n).append(new _S("    ")).append(new _S("maxProposals:")).append(new _S(" ")).append(maxProposals).append(_N.n).append(new _S("    ")).append(new _S("numRounds:")).append(new _S(" ")).append(numRounds).append(_N.n).append(new _S("    ")).append(new _S("proposedClaimMustBeNew:")).append(new _S(" ")).append(proposedClaimMustBeNew).append(_N.n).append(new _S("    ")).append(new _S("minConfidence:")).append(new _S(" ")).append(minConfidence).append(_N.n).append(new _S("    ")).append(new _S("isPersistentPlayground:")).append(new _S(" ")).append(isPersistentPlayground).append(_N.n).append(new _S("    ")).append(new _S("numOfTournamentRounds:")).append(new _S(" ")).append(numOfTournamentRounds).append(_N.n).append(new _S("]")).compress();
   }
